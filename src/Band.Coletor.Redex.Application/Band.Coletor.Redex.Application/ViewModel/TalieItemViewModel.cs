namespace Band.Coletor.Redex.Application.ViewModel
{
    ...
    {
        public static TalieItemViewModel CreateNew(string codigoEmbalagem, string embalagem, string uno, string uno2, string uno3, string uno4, string imo,
                                                   string imo2, string imo3, string imo4, decimal pesoBruto, int quantidade, int codigoRegCs, string resumo
                                                   )
        {
